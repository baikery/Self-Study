...
[ ] 完成 tests/test_matrix.c 单元测试与 CTest 编译
[ ] Week 02: 运动轨迹规划
[ ] 完成 S 型（7段式）加减速算法数学推导文档 (docs/02_scurve_planning.md)
[ ] 写 Python 脚本验证轨迹平滑性 (simulation/s_curve_sim.py)
...
[ ] Python 生成高斯噪声数据，输出 KF 滤波效果对比图，放入 docs/
...
🛠️ README 顶部模板（直接复制使用）
你可以在你的仓库 README.md 开头写上这段，看起来会非常专业：
